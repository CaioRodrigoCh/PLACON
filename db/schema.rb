...
ActiveRecord::Schema.define(version: 2021_04_19_065619) do
  ...
  create_table "subtopicos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.string "titulo"
    t.bigint "topico_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "topicos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    t.string "titulo"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  add_foreign_key "subtopicos", "topicos"
end
